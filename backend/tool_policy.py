...
TOOL_KEYWORDS = {
    ...
    "get_utc_time": {"utc", "timezone", "time"},
    "get_chronometer": {"elapsed", "running", "duration", "chronometer"},
    "date_time_reason": {"day", "date", "days until", "from now", "calendar", "weekday", "utc"},
    "convert_units": {"convert", "celsius", "fahrenheit", "miles", "kilometers", "pounds", "kilograms", "mb", "gb", "bytes"},
    "text_utility": {"uppercase", "lowercase", "reverse", "count words", "count characters", "count lines", "word count", "character count", "line count"},
